...
- [University of California, Irvine(UCI) 기계 학습(ML) 리포지토리](https://archive.ics.uci.edu/ml/datasets/bank+marketing)
...
- 수십G이상의 거대한 데이터를 처리하는 방법
  ...
  - [Machine learning on distributed Dask using Amazon SageMaker and AWS Fargate](https://aws.amazon.com/blogs/machine-learning/machine-learning-on-distributed-dask-using-amazon-sagemaker-and-aws-fargate/)
